...
Next comes adding the arquillian configuration file which will provide the default configuration values for Arquillian.
...
<arquillian xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <extension qualifier="openshift"> <!-- Needed in order to force Arquillian to use Openshift -->
    <property name="namespace.use.current">true</property> <!-- Use the Openshift project instead of creating a testing one -->
    <property name="env.init.enabled">false</property> <!-- This means that Arquillian will not attempt to deploy any Openshift resources. Much more on this later -->
    <property name="enableImageStreamDetection">false</property> <!-- We don't need to enable Image Stream detection since we are going to be initializing the environment -->
    <property name="app.name">spring-boot-rest-http</property> <!-- A custom property that is set to specify the Openshift Route of the application. Will be used later in the test code -->
  </extension>
